...
<h3 style="text-align: center;">Rate(Per Unit)</h3>
       <table border="3" class="table table-bordered-dark mg-b-0">
...
<button type="submit" name="submitpay" class="btn btn-dark rounded">Submit</button>
<div>
</form>
      </div>
    </div>
